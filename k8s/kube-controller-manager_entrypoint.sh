...
# - SECURE_PORT=10257
# - MASTER=http://api-server:8080
# - SERVICE_CLUSTER_IP_RANGE=10.1.0.0/16
# - CLUSTER_CIDR=10.1.0.0/16
# - REQUESTHEADER_CLIENT_CA_FILE=kubernetes-ca.pem
# - CLIENT_CA_FILE=kubernetes-ca.pem
# - CLUSTER_SIGNING_CERT_FILE=kubernetes-ca.pem
# - CLUSTER_SIGNING_KEY_FILE=kubernetes-ca-key.pem
# - TLS_CERT_FILE=kube-controller-manager.pem
# - TLS_PRIVATE_KEY_FILE=kube-controller-manager-key.pem
# - ROOT_CA_FILE=kubernetes-ca.pem
# - SERVICE_ACCOUNT_PRIVATE_KEY_FILE=kubernetes-ca-key.pem
