...
echo "`openssl rand -hex 16`,kubelet-bootstrap,10001,"system:bootstrappers"" > ${PKI_DIR}/bootstrap-token.csv
echo ""
...
${K8S_BIN_DIR}/kubectl config use-context bootstrap --kubeconfig=${PKI_DIR}/kubelet-bootstrap.kubeconfig
